"""
ISS-KE30 Batch Aug-2019
This file is a custom library and called from another python program
Model of generic Hand has been pre-trained and saved as hand pose caffemodel
Extract key features of hand joints
Load all videos from dataset (too big to submit, download link provided)
A few samples of the videos are saved in the "Demo" folder
"""
...
protoFile = "../source/hand/pose_deploy.prototxt"
weightsFile = "../source/hand/pose_iter_102000.caffemodel"   #need to download from source to get latest version and also too big to submit
nPoints = 22
...
while 1:
    ...
    for i in range(nPoints):
        ...
        if prob > threshold :
            ...
            points.append(None)
    #breakpoint()
    # <Points> now contains all the 21 coordinates of the hand joint
